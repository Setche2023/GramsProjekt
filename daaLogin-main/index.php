<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        if($user && password_verify($password, $user["password"])){ 
            ...
            header("Location: php/homepage.php"); // return result to a new page with the new username  and password 
        } else {
    ...
    <form action="index.php" method="post">
        <div class="container">
            ...
            <div class="login">
                ...
                <a href="php/registrierung.php" class="forgot">Registrieren</a>
            </div>
        </div>
    </form>
</body>
