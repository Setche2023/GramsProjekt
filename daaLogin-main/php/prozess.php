<?php
    ...
    if(isset($_POST['ok'])){
            ...
            if($password == $password_confirm){
                ...
                $requete = $connection->prepare("INSERT INTO users (name, vorname, username, email, password, passwort_bestaetigen)  VALUES (:name, :vorname, :username, :email, :password, :passwort_bestaetigen)");
                $requete->execute([                    
                            'name' => $name,
                            'vorname' => $vorname,
                            'username' => $username,
